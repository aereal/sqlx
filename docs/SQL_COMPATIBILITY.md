...
- **Breaking**: `token.Token.ModelType` renamed to `Type`; string-based `token.Type` removed. See [MIGRATION.md](https://github.com/aereal/sqlx/blob/main/docs/MIGRATION.md)
